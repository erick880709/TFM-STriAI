...
export default function PatientRegistrationPage() {
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold text-slate-800 mb-1">📝 Registrar Paciente</h1>
      <p className="text-sm text-slate-500 mb-6">Registro de nuevo paciente o búsqueda de existente</p>
      ...
      {tab === 'search' ? (
        ...
        <form onSubmit={handleSubmit} className="max-w-2xl space-y-5">
          ...
          <div className="bg-white border border-slate-200 rounded-lg p-5">
            <h2 className="font-semibold text-slate-700 mb-4">Datos Básicos</h2>
          ...
          {/* Datos clínicos */}
          <div className="bg-white border border-slate-200 rounded-lg p-5">
            <h2 className="font-semibold text-slate-700 mb-4">Datos Clínicos</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          {/* Contacto */}
          <div className="bg-white border border-slate-200 rounded-lg p-5">
            <h2 className="font-semibold text-slate-700 mb-4">Contacto y Ubicación</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
