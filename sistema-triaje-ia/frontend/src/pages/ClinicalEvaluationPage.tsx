...
export default function ClinicalEvaluationPage() {
  ...
  return (
    <div className="max-w-2xl">
      ...
      <h1 className="text-2xl font-bold text-[#164E63] mb-1">🩺 Evaluación Clínica</h1>
      <p className="text-sm text-[#64748B] mb-6">Motivo de consulta, Glasgow, dolor y comorbilidades</p>

      <div className="space-y-5">
        {/* Motivo */}
        <div className="bg-white border border-[#A5F3FC] rounded-lg p-5">
          <h2 className="font-semibold text-[#164E63] mb-3">Motivo de Consulta</h2>
          <textarea
        ...
        {/* Glasgow */}
        <div className="bg-white border border-[#A5F3FC] rounded-lg p-5">
          <h2 className="font-semibold text-[#164E63] mb-3">Escala de Glasgow</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              ...
              <div key={g.key}>
                <label className="block text-xs font-medium text-[#64748B] mb-1">{g.label}</label>
                <input
        ...
        <div className="bg-white border border-[#A5F3FC] rounded-lg p-5">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              <h2 className="font-semibold text-[#164E63] mb-3">Nivel de Conciencia</h2>
        ...
        {/* Comorbilidades */}
        <div className="bg-white border border-[#A5F3FC] rounded-lg p-5">
          <h2 className="font-semibold text-[#164E63] mb-3">Comorbilidades</h2>
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded-full text-sm border transition-colors ${
                  form.comorbilidades.includes(c)
                    ...
                    : 'bg-white border-[#A5F3FC] text-[#64748B] hover:bg-[#ECFEFF]'
                }`}
              >
                {c}
              </button>
